export default {
  ...
  'oauthApp.form.redirectUris.extra':
    'Each URI must be an exact https URL (http is allowed on localhost only) and is matched exactly.',
  ...
  'oauthApp.redirectUris.empty':
    "No redirect URIs yet. This app can't be used to sign in until you add one.",
