...
beforeAll(async () => {
  ...
  for (const migration of [
    '0159_channel_mvp.sql',
    '0160_channel_thread_followers.sql',
    '0161_channel_member_environment.sql',
    '0162_channel_discussions.sql',
    '0163_channel_discussion_rounds.sql',
  ]) {
    await client.exec(
