 ...
 */
export const conversationGoalPrompt = `The user sent this request with ${BRANDING_NAME}'s /goal command (the prefix was removed before it reached you; it is not your own /goal command). They are asking you to turn the request into a long-running ${BRANDING_NAME} Goal that you supervise from this conversation, not to do the work yourself in this run.
