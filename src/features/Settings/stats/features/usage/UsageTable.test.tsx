...
// deliberately narrow module stubs cannot satisfy. UsageTable.tsx imports
// ProviderIcon from here (not from `@/components/LobeIcons`), so this is the
// module path that actually needs mocking.
