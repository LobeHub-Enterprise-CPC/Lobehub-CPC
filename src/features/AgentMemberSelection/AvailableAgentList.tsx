...
const AvailableAgentList = memo<AvailableAgentListProps>(
  ({ agents, disabled, isLoading, maxCount, onToggle, selectedAgentIds }) => {
              ...
              itemContent={(index) => {
                ...
                return (
                  <AgentItem
                    ...
                    isSelected={selectedAgentIds.includes(row.agent.id)}
                    key={row.agent.id}
                    disabled={
                      disabled ||
                      row.agent.disabled ||
                      (!selectedAgentIds.includes(row.agent.id) &&
