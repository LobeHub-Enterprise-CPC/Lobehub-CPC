...
vi.mock('../constants/identity', () => ({ CLI_DISPLAY_NAME: 'Custom CLI' }));
...
describe('renderReport', () => {
  it('uses the configured CLI identity in the report heading', () => {
    expect(renderReport(report([]))).toContain('Custom CLI doctor');
  });
